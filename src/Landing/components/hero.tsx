    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      >
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="https://wa.me/6285117082122?text=Halo%2C%20saya%20dari%20website%20trasmambang.com%0A%0ASaya%20mau%20cek%20ketersediaan%3A%0ATanggal%3A%20%0AJumlah%20malam%3A%20%0AJumlah%20tamu%3A%20"
            target="_blank"
            className="inline-flex items-center gap-2.5 rounded-full bg-[#25D366] text-white text-sm font-medium uppercase tracking-wide px-8 py-4 hover:bg-[#20bd5a] transition-colors shadow-lg shadow-[#25D366]/20"
          >
            <svg
