				...
				<Accordion type="single" collapsible className="w-full">
					{faqItems.map(({ id, question, answer }) => (
						<AccordionItem
							key={id}
							value={id}
							className="border-b border-[#DADADA] px-0"
						>
							...
							<AccordionContent className="text-[#6B6B6B] pb-6 space-y-3">
								<p>{answer}</p>
								<Link
									href="https://wa.me/6285117082122?text=Halo%2C%20saya%20dari%20website%20trasmambang.com%0A%0ASaya%20mau%20tanya%20lebih%20lanjut"
									target="_blank"
